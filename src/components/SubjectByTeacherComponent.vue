...
<template>
<div class="g-pa-20">
            <h1 class="g-font-weight-300 g-font-size-28 g-color-black g-mb-30">{{title}}</h1>

            <div class="media-md align-items-center g-mb-30">
              <div class="d-flex g-mb-15 g-mb-0--md">
                <h3 class="g-font-weight-400 g-font-size-16 g-color-black mb-0">{{subtitle}}</h3>
              </div>
              ...
              <div class="media d-md-flex align-items-center ml-auto">
                ...
                <div class="d-flex g-ml-15 g-ml-55--md">
                  <div class="input-group g-pos-rel g-width-320--md">
                    <input id="datatableSearch1" class="form-control g-font-size-default g-brd-gray-light-v7 g-brd-lightblue-v3--focus g-rounded-20 g-pl-20 g-pr-50 g-py-10" type="text" placeholder="Search for name, subject">
              ...
              <table class="table u-table--v3 g-color-black">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>10</td>
                    <td>Mr Popoola Ade</td>
                    <td>
                      <a href="/for-single-subject"><span class="btn btn-info g-rounded-50" style="background:#f4f4f4;border-color:#f4f4f4;color:#000;"> <i class="hs-admin-arrow-circle-right"></i></span></a>
                    </td>
                  </tr>
                  <tr>
                    <td>2</td>
                    ...
                    <td>James Sharon</td>
                    <td>
                      <a href="/for-single-subject"><span class="btn btn-info g-rounded-50" style="background:#f4f4f4;border-color:#f4f4f4;color:#000;"> <i class="hs-admin-arrow-circle-right"></i></span>
                      </a>
                    </td>
                  </tr>
                  <tr>
...
<script>
  export default {
    name:"SubjectByTeacherComponent",
