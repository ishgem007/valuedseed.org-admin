        ...
        <div class="media">
          ...
          <div class="media-body align-self-center">
            <div class="d-flex align-items-center g-mb-5">
              <span class="g-font-size-24 g-line-height-1 g-color-black">23</span>
              ...
              <h6 class="g-font-size-16 g-font-weight-300 g-color-gray-dark-v6 mb-0">Admin</h6>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="card h-100 g-brd-gray-light-v7 u-card-v1 g-rounded-3">
      <div class="card-block g-font-weight-300 g-pa-20">
        <div class="media">
          ...
          <div class="media-body align-self-center">
            <div class="d-flex align-items-center g-mb-5">
              <span class="g-font-size-24 g-line-height-1 g-color-black">203</span>
               <span class="d-flex align-self-center g-font-size-0 g-ml-5 g-ml-10--md">
                 <i class="g-fill-gray-dark-v9">
                  <svg width="12px" height="20px" viewbox="0 0 12 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <g transform="translate(-21.000000, -751.000000)">
              ...
              <h6 class="g-font-size-16 g-font-weight-300 g-color-gray-dark-v6 mb-0">Customers</h6>
            </div>
          </div>
        </div>
      </div>
                ...
                <div class="card-block g-font-weight-300 g-pa-20">
                  <div class="media">
                    ...
                    <div class="media-body align-self-center">
                      ...
                      <h6 class="g-font-size-16 g-font-weight-300 g-color-gray-dark-v6 mb-0">Beneficiary</h6>
                    </div>
                  </div>
                </div>
              </div>
