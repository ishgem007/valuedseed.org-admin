        ...
        <div class="col-auto d-flex g-py-12 g-pl-40--lg ml-auto">
          ...
          <div class="g-pos-rel g-hidden-sm-down g-mr-5">
              ...
              <ul class="p-0 mb-0">
                ...
                <li class="media g-pos-rel u-header-dropdown-item-v1 g-pa-20">
                  <div class="d-flex g-mr-15">
                    <img class="g-width-40 g-height-40 rounded-circle" src="b-assets/assets/img-temp/100x100/img5.jpg" alt="Image Description">
                  </div>
            ...
            <i class="hs-admin-time icon-clock g-mr-5"></i> <small>5 Min ago</small>
                ...
                <li class="media g-pos-rel u-header-dropdown-item-v1 g-pa-20">
                  <div class="d-flex g-mr-15">
                    <img class="g-width-40 g-height-40 rounded-circle" src="b-assets/assets/img-temp/100x100/img6.jpg" alt="Image Description">
                  </div>
            ...
            <i class="hs-admin-time icon-clock g-mr-5"></i> <small>22 Min ago</small>
                ...
                <li class="media g-pos-rel u-header-dropdown-item-v1 g-pa-20">
                  <div class="d-flex g-mr-15">
                    <img class="g-width-40 g-height-40 rounded-circle" src="b-assets/assets/img-temp/100x100/img7.jpg" alt="Image Description">
                  </div>
