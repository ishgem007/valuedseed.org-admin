      ...
      <nav class="navbar no-gutters g-pa-0">
        <div class="col-auto d-flex flex-nowrap u-header-logo-toggler g-py-12">
          ...
          <a href="#" class="navbar-brand d-flex align-self-center g-hidden-xs-down g-line-height-1 py-0 g-mt-5">
            <img src="assets/assets/img/logo.png" alt="ValuedSeed" width="86px" height="32px">
          </a>
          <!-- End Logo -->
              ...
              <ul class="p-0 mb-0">
                ...
                <li class="media u-header-dropdown-item-v1 g-parent g-px-20 g-py-15">
                  ...
                  <div class="media-body align-self-center">
                    <p class="mb-0"><a href="/notification">A Pocket PC is a handheld computer features</a></p>
                  </div>
                ...
                <li class="media u-header-dropdown-item-v1 g-parent g-px-20 g-py-15">
                  ...
                  <div class="media-body align-self-center">
                    <p class="mb-0"><a href="/notification">The first is a non technical method which requires</a></p>
                  </div>
                ...
                <li class="media u-header-dropdown-item-v1 g-parent g-px-20 g-py-15">
                  ...
                  <div class="media-body align-self-center">
                    <p class="mb-0"><a href="/notification">Stu Unger is of the biggest superstarsis</a></p>
                  </div>
                ...
                <li class="media u-header-dropdown-item-v1 g-parent g-px-20 g-py-15">
                  ...
                  <div class="media-body align-self-center">
                    <p class="mb-0"><a href="/notification">Sony laptops are among the most well known laptops</a></p>
                  </div>
        ...
        <span class="g-hidden-sm-down">Charlie Bailey</span>
              ...
              <ul id="profileMenu" class="g-pos-abs g-left-0 g-width-100x--lg g-nowrap g-font-size-14 g-py-20 g-mt-17 rounded" aria-labelledby="profileMenuInvoker">
                <li class="g-mb-10">
                  <a class="media g-color-primary--hover g-py-5 g-px-20" href="/profile">
