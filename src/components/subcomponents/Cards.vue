                      ...
                      <div class="media-md align-items-center g-parent g-bg-gray-light-v8--sibling-checked g-brd-around g-brd-gray-light-v7 g-rounded-4 g-px-20 g-py-15">
                        <div class="d-flex-md text-center g-mb-20 g-mb-0--md">
                          <div class="d-inline-block u-icon-v3 u-icon-size--lg g-bg-gray-light-v8 g-bg-gray-light-v7--parent-sibling-checked g-font-size-24 g-color-secondary rounded-circle">
                            ...
                            <img class="img-fluid g-width-40" src="assets/assets/img/icons/visa.svg" alt="Image description">
                          </i>
                          </div>
                        </div>
                    ...
                    <label class="js-check g-pos-rel d-block g-mb-20">
                      ...
                      <div class="media-md align-items-center g-parent g-bg-gray-light-v8--sibling-checked g-brd-around g-brd-gray-light-v7 g-rounded-4 g-px-20 g-py-15">
                        <div class="d-flex-md text-center g-mb-20 g-mb-0--md">
                          <div class="d-inline-block u-icon-v3 u-icon-size--lg g-bg-gray-light-v8 g-bg-gray-light-v7--parent-sibling-checked g-font-size-24 g-color-secondary rounded-circle">
                            <i class="g-font-size-0">
                            <img class="img-fluid g-width-40" src="assets/assets/img/icons/mastercard.svg" alt="Image description">
                          </i>
                          </div>
                        </div>
                    ...
                    <label class="g-pos-rel d-block g-mb-20">
                      ...
                      <div class="media-md align-items-center g-parent g-bg-gray-light-v8--sibling-checked g-brd-around g-brd-gray-light-v7 g-rounded-4 g-px-20 g-py-15">
                        <div class="d-flex-md text-center g-mb-20 g-mb-0--md">
                          <div class="d-inline-block u-icon-v3 u-icon-size--lg g-bg-gray-light-v8 g-bg-gray-light-v7--parent-sibling-checked g-font-size-24 g-color-secondary rounded-circle">
                            <i class="g-font-size-0">
                            <img class="img-fluid g-width-40" src="assets/assets/img/icons/jcb.svg" alt="Image description">
                          </i>
                          </div>
                        </div>
                    ...
                    <label class="js-check g-pos-rel d-block g-mb-30">
                      ...
                      <div class="media-md align-items-center g-parent g-bg-gray-light-v8--sibling-checked g-brd-around g-brd-gray-light-v7 g-rounded-4 g-px-20 g-py-15">
                        <div class="d-flex-md text-center g-mb-20 g-mb-0--md">
                          <div class="d-inline-block u-icon-v3 u-icon-size--lg g-bg-gray-light-v8 g-bg-gray-light-v7--parent-sibling-checked g-font-size-24 g-color-secondary rounded-circle">
                            <i class="g-font-size-0">
                            <img class="img-fluid g-width-40" src="assets/assets/img/icons/paypal.svg" alt="Image description">
                          </i>
                          </div>
                        </div>
                    ...
                    <label class="js-check g-pos-rel d-block g-mb-30">
                      ...
                      <div class="media-md align-items-center g-parent g-bg-gray-light-v8--sibling-checked g-brd-around g-brd-gray-light-v7 g-rounded-4 g-px-20 g-py-15">
                        <div class="d-flex-md text-center g-mb-20 g-mb-0--md">
                          <div class="d-inline-block u-icon-v3 u-icon-size--lg g-bg-gray-light-v8 g-bg-gray-light-v7--parent-sibling-checked g-font-size-24 g-color-secondary rounded-circle">
                            <i class="g-font-size-0">
                            <img class="img-fluid g-width-40" src="assets/assets/img/icons/payoneer.svg" alt="Image description">
                          </i>
                          </div>
                        </div>
                    ...
                    <label class="js-check g-pos-rel d-block g-mb-30">
                      ...
                      <div class="media-md align-items-center g-parent g-bg-gray-light-v8--sibling-checked g-brd-around g-brd-gray-light-v7 g-rounded-4 g-px-20 g-py-15">
                        <div class="d-flex-md text-center g-mb-20 g-mb-0--md">
                          <div class="d-inline-block u-icon-v3 u-icon-size--lg g-bg-gray-light-v8 g-bg-gray-light-v7--parent-sibling-checked g-font-size-24 g-color-secondary rounded-circle">
                            <i class="g-font-size-0">
                            <img class="img-fluid g-width-40" src="assets/assets/img/icons/skrill.svg" alt="Image description">
                          </i>
                          </div>
                        </div>
