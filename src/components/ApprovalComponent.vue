<template>
    ...
    <div id="approval-form" class="rounded-0 p-0" style="display: none; width: 500px; max-width: 100%;">
    <header class="g-bg-gray-light-v8 g-px-15 g-px-30--sm g-py-20">
      <h2 class="g-font-weight-300 g-font-size-16 g-color-black mb-0">Approve This Subject</h2>
    </header>

    <div class="g-pa-15 g-pa-30--sm">
      <form>
        <h3 class="g-mb-20">
        <span class="g-font-weight-300 g-font-size-20 g-color-black">Price (NGN)</span>
      </h3>
      <div class="form-group g-mb-35">
          <input type="text" class="form-control form-control-md g-resize-none g-line-height-1_6 g-brd-gray-light-v7 g-brd-lightblue-v3--focus g-pa-20"/>
        </div>

        <h3 class="g-mb-20">
        <span class="g-font-weight-300 g-font-size-20 g-color-black">Remark</span>
      </h3>

        <div class="form-group g-mb-35">
          <textarea class="form-control form-control-md g-resize-none g-line-height-1_6 g-brd-gray-light-v7 g-brd-lightblue-v3--focus g-pa-20" rows="5" placeholder="enter a remark here">

          </textarea>
        </div>
        <div class="g-mb-45">
          <h3 class="g-font-weight-300 g-font-size-16 g-color-black g-mb-20">Upload Cover Image</h3>

          <div class="media g-brd-bottom g-brd-gray-light-v7 g-pb-15">
            <div class="media-body d-flex g-ml-10 g-ml-0--sm">
              <div class="g-mb-5">
        ...
        <div class="d-flex">
          <button class="btn btn-xl u-btn-secondary g-width-160--md g-font-size-14 g-mr-15" type="submit">Save</button>
